...
{
    public:
        ButtonTest(graphics::Graphics* gfx, const std::string& name)
            : Button(gfx), m_name(name)
        {}
        virtual ~ButtonTest()
        {}

        virtual void select() {
            std::cout << "Selected \"" << m_name << "\" button." << std::endl;
        }
...
int main()
{
    ...
    gfx->loadTexture("un",  "guirc/button/un.png");
    gfx->loadTexture("foc", "guirc/button/foc.png");
    gfx->loadTexture("sel", "guirc/button/sel.png");
    ButtonTest b00(gfx, "0x0");
    b00.setTextures("un", "foc", "sel");
    ButtonTest b01(gfx, "0x1");
    b01.setTextures("un", "foc", "sel");
    ButtonTest b1(gfx, "1x*");
    b1.setTextures("un", "foc", "sel");
