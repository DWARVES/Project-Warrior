...
namespace gui
{
    ...
    class Button : public Widget
    {
        public:
            ...
            virtual void select();
            /** @brief Indicates if the button has been clicked in last gui update. Can be called only once for each gui update. */
            bool clicked() const;
        ...
        private:
            ...
            mutable bool m_clicked;         /**< @brief Has the button been clicked in last gui update. */
    };
}
